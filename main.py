...
class Players:
    ...
    def __init__(self, name):
        ...
        while succes == False:
            ...
            for player in players:
                # print('checking '+str(self.pos[0]-player.pos[0])+" in ("+str(reso[0]*0.1))
    ...
    # function to make the tank set the tank to the first position after being fired
    def fire(self):
